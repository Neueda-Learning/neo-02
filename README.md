...
that role can only touch this repo's own `neobank-<env>-neo-02` stack. You never hold AWS
credentials yourself — everything that reaches AWS goes through a workflow in this repo.

The front-end image is built with `APP_BASE_PATH=/neo-02`, because in the deployed stack
...
|---|---|---|---|
| **dev** | [`/neo-02/`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-02/) | [`/neo-02/health`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-02/health) · [`/neo-02/info`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-02/info) | [orchestrator](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/) |
| **prod** | [`/neo-02/`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-02/) | [`/neo-02/health`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-02/health) · [`/neo-02/info`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-02/info) | [orchestrator](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/) |
...
A `reset` destroys **only this service's schema** (`neo_02`). Every other service and the
...
DB_URL=jdbc:mysql://localhost:3307/neo_02 ./mvnw spring-boot:run
```
...
| Env | Default | What |
|---|---|---|
| `SERVICE_ID` | `neo02` | the id sent on callbacks — note **no `-a`**, unlike the repo name |
...
| `HTTP_CONNECT_TIMEOUT_MS` | `2000` | maximum connection time for synchronous dependency calls |
| `HTTP_READ_TIMEOUT_MS` | `5000` | maximum response wait for synchronous dependency calls |
