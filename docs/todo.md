...
- [x] UC03: `GET /cases/{applicationId}/applicant` is a live orchestrator proxy; Decision Detail
  hydrates its applicant sidebar independently, supports retry, and stores or caches no applicant
  data.
